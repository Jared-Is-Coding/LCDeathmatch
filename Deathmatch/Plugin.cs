...
namespace Deathmatch
{
	...
	public class BasePlugin : BaseUnityPlugin
	{
		...
		private const string ModGUID = "jarediscoding.deathmatch";
		private const string ModName = "Deathmatch";
		...
		void Awake()
		{
			...
			LogSource.LogDebug($"Deathmatch.Patches.StorePatch complete");
